...
def main(argv: Sequence[str] | None = None) -> int:
    ...
    parser.add_argument("--output", default="benchmark_outputs/full_data_hybrid/strict120_open_thm_grasp_no2opt_full_pick.csv")
    parser.add_argument(
        "--alternative-locations-output",
        default="benchmark_outputs/full_data_hybrid/strict120_open_thm_grasp_no2opt_full_alt.csv",
    )
    parser.add_argument(
        "--summary-output",
        default="benchmark_outputs/full_data_hybrid/strict120_open_thm_grasp_no2opt_summary.json",
    )
