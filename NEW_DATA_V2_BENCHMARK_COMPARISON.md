...
- Real-life picks used as a rerouted baseline: `NEW_DATA/PickData.csv`
- Column check result:
  ...
  - the stock file was normalized before running the solvers:
    - `benchmark_outputs/new_data_v2_5min/normalized_stock.csv`
...
Baseline artifacts:
- `benchmark_outputs/new_data_v2_5min/real_pick_rerouted_pick.csv`
- `benchmark_outputs/new_data_v2_5min/real_pick_rerouted_alt.csv`
- `benchmark_outputs/new_data_v2_5min/real_pick_rerouted_summary.json`
...
- All pick and alternative-location outputs:
  - `benchmark_outputs/new_data_v2_5min/`
- Per-solver logs:
  - `benchmark_outputs/new_data_v2_5min/logs/`
- Batch execution summary:
  - `benchmark_outputs/new_data_v2_5min/run_summary.json`
