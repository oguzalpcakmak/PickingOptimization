...
double Alpha;           /* Travel cost per unit of distance in a
                           PTP instance */
...
int Drones;             /* Number of drones in a TSPMD */
double Endurance;       /* The drone endurance in a TSPMD */
int EdgeFiles;          /* Number of EDGE_FILEs */
double CostLimit;       /* Maximum cost for an OP instance */
...
int GVRPSets;   /* Number of GVRP sets */
...
extern int IsChild;    /* Is the current tour a child created by the
                          crossover operator? */
...
int IsChild;    /* Is the current tour a child tour */
int k;          /* The k-value for solving a k-TSP instance */
...
int Probability;           /* The probability for PTSP (in percent) */
