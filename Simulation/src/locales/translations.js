...
export const translations = {
  tr: {
    ...
    solve: 'Çöz',
    solverModeClientLkh: 'Client-side çözüm',
    solverModeClientCpp: 'Client-side LKH’siz',
    solverModeServerQuality: 'Server-side çözüm',
  ...
  en: {
    ...
    solve: 'Solve',
    solverModeClientLkh: 'Client-side solution',
    solverModeClientCpp: 'Client-side without LKH',
    solverModeServerQuality: 'Server-side solution',
