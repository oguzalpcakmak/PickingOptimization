...
def main(argv: list[str] | None = None) -> int:
    ...
    parser.add_argument("--output-dir", default="benchmark_outputs/full_data_imported_tsp")
    parser.add_argument("--summary-output", default="benchmark_outputs/full_data_imported_tsp/run_summary.json")
