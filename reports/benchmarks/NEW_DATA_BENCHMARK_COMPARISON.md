...
- Real-life picks available but not used for this run: `data/new_data/PickData.csv`
...
- Normalized stock file used for all runs:
  - `outputs/benchmark_outputs/new_data_5min/normalized_stock.csv`
...
Baseline artifacts:
- `outputs/benchmark_outputs/new_data_5min/real_pick_rerouted_pick.csv`
- `outputs/benchmark_outputs/new_data_5min/real_pick_rerouted_alt.csv`
- `outputs/benchmark_outputs/new_data_5min/real_pick_rerouted_summary.json`
...
- All pick and alternative-location outputs:
  - `outputs/benchmark_outputs/new_data_5min/`
- Per-solver logs:
  - `outputs/benchmark_outputs/new_data_5min/logs/`
- Batch execution summary:
  - `outputs/benchmark_outputs/new_data_5min/run_summary.json`
