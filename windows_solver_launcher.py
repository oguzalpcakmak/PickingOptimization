...
def main() -> int:
    ...
    print()
    print("Data mode")
    print("  1. Full data (PickOrder.csv + StockData.csv, no filters)")
    ...
    if mode == "1":
        ...
        orders = ask_text("Orders CSV path", "PickOrder.csv")
        stock = ask_text("Stock CSV path", "StockData.csv")
    ...
    print()
    output_dir_text = ask_text("Output directory", r"benchmark_outputs\windows_runs")
